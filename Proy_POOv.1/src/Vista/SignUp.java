/*
 * Optimizar usando archivos txt y que busque a los empleados en ella 
 *
 */
package Vista;
...
public class SignUp extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(contratxt, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(176, 176, 176)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String pass = this.contratxt.getText();
        
        if(nombre.isEmpty() || id.isEmpty() || usuario.isEmpty() || pass.isEmpty()){
            JOptionPane.showMessageDialog(null, "Algún campo esta vacio");
            
        }else{
                Empleado unEmpleado = new Empleado(id,nombre,usuario,pass);
        ...
        for (int i = 0; i < IniciaAplicacion.listaEmpleado.size(); i++) {
            ...
            pst.setString(1, listaEmpleado.get(i).getId());
            pst.setString(2, listaEmpleado.get(i).getNombre());
            pst.setString(3, listaEmpleado.get(i).getUsuario());
            pst.setString(4, listaEmpleado.get(i).getContra());
            pst.executeUpdate();
