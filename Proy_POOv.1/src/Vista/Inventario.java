...
import Modelo.TablaModeloInventario;
...
public class Inventario extends javax.swing.JFrame {
    TablaModeloInventario datos = new TablaModeloInventario();
    /**
    ...
    public Inventario() {
        ...
        datos.incializaTabla(InventarioTabla);
    }
    ...
    private void initComponents() {
        ...
        InventarioTabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Precio", "Cantidad", "Title 4", "Title 5", "Title 6"
            }
        ) {
...
int fsel;
        ...
        String fill;
        try{
            fsel = InventarioTabla.getSelectedRow();
            if(fsel== -1){
                JOptionPane.showMessageDialog(null, "Debe seleccionar un producto ");
            } else{
                respuesta = JOptionPane.showConfirmDialog(null, "Seguro quieres eliminarlo?","Eliminar",JOptionPane.YES_NO_OPTION);
            if(respuesta == JOptionPane.YES_OPTION){
                     m = (DefaultTableModel)InventarioTabla.getModel();
                    m.removeRow(fsel);
                    IniciaAplicacion.listaInventario.remove(fsel);
